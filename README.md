...
Anand keeps his own screen (depth 10, 90cp) and, unlike a rung, takes the move
*he* ranked highest among the survivors rather than the one that was sampled.
His `aggression` is 0 for that reason: a tilt on a move he then overrides would
be theatre. His personality is in his lines.
